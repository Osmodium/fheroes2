...
namespace
{
    ...
    public:
        ...
        void ActionListDoubleClick( Game::HotKeyEvent & hotKeyEvent ) override
        {
            ...
            const fheroes2::Key fullscreenEventKey = Game::getHotKeyForEvent( Game::HotKeyEvent::GLOBAL_TOGGLE_SCREEN_MODE );
            ...
            Game::setHotKeyForEvent( Game::HotKeyEvent::GLOBAL_TOGGLE_SCREEN_MODE, fheroes2::Key::NONE );
            ...
            Game::setHotKeyForEvent( Game::HotKeyEvent::GLOBAL_TOGGLE_SCREEN_MODE, fullscreenEventKey );
